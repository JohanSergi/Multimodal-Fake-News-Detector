...
class MultimodalDataset(Dataset):
    ...
    def __init__(
        ...
        # set dataframe filename prefix BEFORE preprocessing
        ...
        if not from_preprocessed_dataframe:
            # first time preprocessing dataset
    ...
    def _preprocess_df(self, df):
        ...
        df = df.drop(['created_utc', 'domain', 'hasImage', 'image_url'], axis=1,errors='ignore')
